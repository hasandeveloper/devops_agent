...
| Document | Purpose |
|---|---|
| `documentation/rds-agent/pipeline-end-to-end.md` | How the RDS investigation works from start to finish |
| `documentation/rds-agent/readonly-db-role-setup.md` | How the read-only database user is configured |
| `documentation/rag/pgvector-retrieval.md` | How similar incidents are stored and retrieved |
| `documentation/devops/monitoring-setup.md` | How to configure CloudWatch alarms |
